                  ...
                  <div class="box-body">
                    <div class="tabbable header-tabs">
                      <ul class="nav nav-tabs">
                        ...
                        <li class="active"><a href="#tab-general" data-toggle="tab"><i class="fa fa-home"></i> <span class="hidden-inline-mobile"><?php echo $tab_general; ?></span></a></li>
                      </ul>
                    </div>
                    ...
                    <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                        ...
                        <div class="tab-pane clearfix" id="tab-links">
                        ...
                        <div class="tab-pane clearfix" id="tab-attribute">
                        ...
                        <div class="tab-pane clearfix" id="tab-option">
                          <div class="row">
                            <div class="col-sm-2">
                        ...
                        <div class="tab-pane clearfix" id="tab-recurring">
                          <div class="table-responsive">
                        ...
                        <div class="tab-pane clearfix" id="tab-discount">
                          <div class="table-responsive">
                        ...
                        <div class="tab-pane clearfix" id="tab-special">
                          <div class="table-responsive">
                        ...
                        <div class="tab-pane clearfix" id="tab-image">
                          <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover">
                              <thead>
                              <tr>
                        ...
                        <div class="tab-pane clearfix" id="tab-reward">
                          <div class="form-group">
